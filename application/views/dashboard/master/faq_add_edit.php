            ...
            <div class="formblock-box">
                     ...
                     <div class="form-group">
                        <div class="input-group input-group-sm">
                           <input type="text" class="form-control" name="faq_question" id="faq_question"
                              placeholder="Enter Question" value="<?php if($bodycontent['mode'] == 'EDIT'){echo $bodycontent['faqEditdata']->faq_question;}?>" autocomplete="off">
                        </div>
                     </div>
                  </div>
               </div>
               ...
               <div class="col-md-2">   </div>
                  <div class="col-md-8">
                     ...
                     <div class="form-group">
                        <div class="input-group input-group-sm">
                            <textarea  class="form-control" name="faq_answer" id="faq_answer" cols="5" rows="5"><?php if($bodycontent['mode'] == 'EDIT'){echo $bodycontent['faqEditdata']->faq_answer;}?></textarea>
                            </div>
                     </div>
                  </div>
               </div>
