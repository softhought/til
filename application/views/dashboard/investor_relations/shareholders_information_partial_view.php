            ...
            <tr>
               ...
               <td style="text-align:center;">
                  <a href="javascript:void(0);" class="btn tbl-action-btn padbtn showupdatebtn"
                     ...
                     data-relationsmasterid="<?php echo $value->relations_master_id; ?>" data-toggle="modal"
                     data-target="#investorRelationsDetails">
               ...
               <td align="center"> <?php if ($value->is_disabled == 0) { ?>
                     <a href="javascript:void(0);"><img src="<?php echo base_url(); ?>assets-admin/img/active-icon.png"
                           alt="Active" title="Active" id="<?php echo ($value->relations_dtl_id); ?>" class="relstatus"
                           data-setstatus=1 data-relationsmasterid="<?php echo $value->relations_master_id; ?>"></a>
                  <?php } else { ?>
                     <a href="javascript:void(0);"><img src="<?php echo base_url(); ?>assets-admin/img/inactive2.png"
                           alt="Inactive" title="Inactive" id="<?php echo ($value->relations_dtl_id); ?>" class="relstatus"
                           data-setstatus=0 data-relationsmasterid="<?php echo $value->relations_master_id; ?>"> </a>
                  <?php } ?>
               </td>
