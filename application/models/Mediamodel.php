...
class Mediamodel extends CI_Model
{
    ...
    {
        $query = $this->db->query("SELECT SUM(`investor_relations_details`.`fileupload_count`) as total FROM `investor_relations_details` WHERE `investor_relations_details`.`relations_dtl_id` = 44");
