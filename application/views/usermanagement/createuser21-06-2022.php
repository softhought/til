...
<section class="layout-box-content-format1">
    ...
    <div class="card card-primary form-view">
        ...
        <div class="card-header box-shdw">
            ...
            <div class="btn-group btn-group-sm float-right" role="group" aria-label="MoreActionButtons" style="padding: 8px 19px;!importent">
                <!-- ------------show log------------- -->
                <a href="javascript:;" class="logHistory <?php echo showlog();?>" data-toggle="modal"
            ...
            <div class="row">
                ...
                <div class="col-md-2">
                    ...
                    <button type="submit" class="btn btn-sm action-button padbtn"
                        id="create_btn"><?php echo $bodycontent['btnText'];?> &nbsp;<i class="fas fa-chevron-right"></i></button>
