	...
	{   
		...
		{ 
          /*  $where_isactive = array(
            ...
            $result['no_res_url']  = $this->commondatamodel->getSingleRowByWhereCls('no_user_restriction',$where_isactive); 

            if($result['no_res_url'])
            {
    ...
    public function store()
    {
		...
		{  
          ...
          //  $access_permission=$this->input->post('access_permission');
            ...
            $sel_chapter=implode(',',$this->input->post('sel_chapter'));
            $password=$this->input->post('password');
          //  $is_ir_person = $this->input->post('is_ir_person') != NULL ?'Y':'N';
             $is_deal_manger = $this->input->post('is_deal_manger') != NULL ?'Y':'N';
