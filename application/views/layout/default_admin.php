    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-1">
            ...
            <a href="<?php echo base_url(); ?>dashboard" class="brand-link">
                <!-- <img src="<?php echo(base_url());?>assets-admin/img/MA2.png" alt="Mumbai Anegls" class="brand-image"
           style="opacity: .8"> -->
                <span class="brand-text"><span class="brand-text-start">TIL</span><span class="brand-text-end"> INDIA</span></span>
                <!-- <img src="<?php echo(base_url());?>assets-admin/img/Ma_Trix_Logo_2.png" alt="Mumbai Anegls" height="15%"
                    width="75%"> -->
            </a>
