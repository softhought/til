        ...
        <ul id="menu-top-menu" class="nav navbar-nav ">
          ...
          <li class="about"><a href="<?php echo base_url(); ?>about-us" class="dropdown-toggle">About Us <span
            ...
            <ul class="dropdown-menu dropdownhover-bottom">
              ...
              <li><a href="<?php echo base_url(); ?>about-us/corporate-social-responsibility">Corporate Social
                  Responsibility</a></li>
          ...
          <li class="customer-support"><a href="<?php echo base_url(); ?>customer-support">Customer Support <span
            ...
            <ul class="dropdown-menu dropdownhover-bottom">
              <li class="first"><a href="<?php echo base_url(); ?>customer-support/maintenance-contract">Maintenance
                  Contract</a></li>
              <li><a href="<?php echo base_url(); ?>customer-support/parts-warehouse">Parts & Warehouse</a></li>
              <li><a href="<?php echo base_url(); ?>customer-support/training">Training</a></li>
    ...
    <div class="container">
      <div class="row ">
        ...
        <div class="col-lg-4 col-md-3 col-12 contact-details contact-fix">
          <div>
            <p class="fontYlw">Toll Free Number:<span class="font_number"><a href="tel:18002661535">1800 266
                  1535</a></span></p>
            <p class="fontYlw">Email:<span class="font_number"><a
                  href="mailto:mktg-til@tilindia.com">mktg-til@tilindia.com</a></span> </p>
            <div>
      ...
      <form enctype="multipart/form-data" class="contact_form" id="contact_form" method="POST" accept-charset="utf-8">
        ...
        <div class="form-group">
          ...
          <div class="input-container">
            <svg xmlns="http://www.w3.org/2000/svg" height="16" width="14" viewBox="0 0 384 512">
              <path
              ...
              <form action="" enctype="multipart/form-data" class="quotation_form" id="quotation_form" method="POST"
                ...
                <div class="form-group">
                  ...
                  <div class="input-container">
                    ...
                    <div id="produt_id_drp">
                      <select type="select" name="product_id" autocomplete="off" id="produt_id" required="required"
