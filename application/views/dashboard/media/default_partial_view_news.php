...
<form id="newsandnewslaterForm" class="newsandnewslaterForm mb-4" method="post" enctype="multipart/form-data">
   ...
   <div class="row">
      ...
      <div class="col-md-2">
         ...
         <div class="form-group">
            <div class="input-group input-group-sm">
               <input type="text" class="form-control forminputs typeahead url" id="url" name="url"
                  placeholder="Enter URL" autocomplete="off" value="">
      ...
      <div class="col-md-3">
         <div class="row">
            <div class="col-md-10">
               ...
               <input type="file" name="fileName" class="file fileName" id="fileName" accept="image/*">
