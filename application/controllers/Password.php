...
class password extends CI_Controller {
    ...
    public function sendpasskey(){
        ...
        $result=$this->commondatamodel->getSingleRowByWhereCls('users',$where, $username);
      ...
      public function verifypasskey(){
       ...
       $update = $this->commondatamodel->updateSingleTableData('users',$update_data,$where, $user_email);
