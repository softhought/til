            ...
            <div class="formblock-box">
                ...
                <form onsubmit="return CreateUserFrmValidate();" action="<?php echo base_url();?>user/store"
                    ...
                    <div class="row">
                        ...
                        <div class="row">
                        <div class="col-md-3">
                            <label for="user_role_id">Chapter*</label>
                            <div id="user_role_idDiv" class="form-group">
                                <div class="input-group input-group-sm">
                                    <select class="form-control select2" data-show-subtext="true" name="sel_chapter[]"
                                        id="sel_chapter" data-show-subtext="true" data-actions-box="true"
                                        data-live-search="true" multiple="multiple">

                                        <?php foreach ($bodycontent['chapterList'] as $value) { ?>
                                        <option value="<?php echo $value->chapter_id; ?>" <?php if($bodycontent['mode']=="EDIT"){
                                    $chapterIDs=explode(',',$bodycontent['userEditdata']->chapter_ids);
                                      if (in_array($value->chapter_id,$chapterIDs))
                                        {
                                        echo "selected";
                                        }
                            ...
                            <!--   <div class="col-md-2">
                             ...
                             <div class="col-md-3">
                             <label for="is_deal_manger" >Is Deal Manger</label>
                             <div class="form-group" style="margin-left: 12px;margin-top: 6px;">
                                        <div class="input-group input-group-sm">
                                         <input type="checkbox" class="rowCheck inputcheck" name="is_deal_manger" id="is_deal_manger"  <?php if($bodycontent['mode'] == 'EDIT' && $bodycontent['userEditdata']->is_deal_manger == 'Y'){ echo 'checked'; } ?> value=" <?php if($bodycontent['mode'] == 'EDIT'  && $bodycontent['userEditdata']->is_deal_manger == 'Y'){ echo 'Y'; }else{ echo 'N'; } ?>" >
                                        </div>
                                  </div>       
                             </div>
