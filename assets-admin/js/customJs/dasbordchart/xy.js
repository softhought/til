							...
							"zoomX" !== i && "zoomXY" !== i || 0 == u || this.xAxes.each((function (e) {
								if (e.get("zoomX")) {
									var i = e.get("start"),
										...
										l = i - s * (a - i) * u * n,
										h = a + s * (a - i) * u * (1 - n);
									1 / (h - l) < e.get("maxZoomFactor", 1 / 0) / e.get("minZoomCount", 1) && t._handleWheelAnimation(e.zoom(l, h))
								}
								...
								if (e.get("zoomY")) {
									var i = e.get("start"),
										...
										u = i - s * (a - i) * l * n,
										h = a + s * (a - i) * l * (1 - n);
									1 / (h - u) < e.get("maxZoomFactor", 1 / 0) / e.get("minZoomCount", 1) && t._handleWheelAnimation(e.zoom(u, h))
								}
				...
				p = function (e) {
					...
					return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_dispose", {
						...
						value: function () {
							...
							i && (i.axis = this, i.processAxis()), this.children.push(i), this.ghostLabel = i.makeLabel(new r.z(this, void 0, {}), []), this.ghostLabel.set("opacity", 0)
						}
						...
						value: function () {
							...
							if (!e.isHidden()) {
								var t = e.localBounds(),
									i = t.right - t.left;
								u.each(this.dataItems, (function (t) {
									var a = t.get("label");
									if (a && !a.isHidden()) {
										var r = a.localBounds();
							...
							var a = this.get("start", 0),
								r = this.get("end", 1);
							this.get("renderer").updateLabel(e, a + .5 * (r - a))
						}
					}), Object.defineProperty(t.prototype, "_handleCursorPosition", {
						enumerable: !1,
						configurable: !0,
						...
						value: function () {
							...
							})), a && (r.updateTooltipBounds(a), this.get("snapTooltip") && (i = this.roundAxisPosition(i, this.get("tooltipLocation", .5))), h.isNaN(i) ? a.hide(0) : (this._updateTooltipText(a, i), r.positionTooltip(a, i), i < this.get("start") || i > this.get("end") ? a.hide(0) : a.show(0))))
						}
					...
					return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
						...
						value: function () {
							...
							if (u.isNumber(t) && u.isNumber(i)) {
								...
								c = Math.floor(c / d) * d, this._frequency = d;
								...
								if (w.length > 0) {
									...
									o.each(w, (function (t) {
										var i;
										e.dataItems.length < S + 1 ? (i = new n.z(e, void 0, {}), e._dataItems.push(i), e.processDataItem(i)) : i = e.dataItems[S];
										var a = r[t],
											o = new Date(a),
											s = a;
										if (S < w.length - 1 ? s = r[w[S + 1]] : s += _, i.setRaw("value", a), i.setRaw("endValue", s), i.setRaw("index", S), t > c - 100 && t < p + 100) {
											var h = x[v.timeUnit];
											h = x[v.timeUnit], F && e.get("markUnitChange") && u.isNumber(X) && "year" != v.timeUnit && l.checkChange(a, X, F, e._root.utc, e._root.timezone) && (h = e.get("periodChangeDateFormats")[v.timeUnit]), e._createAssets(i, []);
											var b = i.get("label");
					...
					return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "markDirtyExtremes", {
						...
						value: function () {
							...
							if (s.isNumber(e) && s.isNumber(t)) {
								...
								for (; h < o;) {
									var d = void 0;
									this.dataItems.length < c + 1 ? (d = new r.z(this, void 0, {}), this._dataItems.push(d), this.processDataItem(d)) : d = this.dataItems[c], this._createAssets(d, []), d.isHidden() && d.show(), d.setRaw("value", h);
									var g = d.get("label");
									g && g.set("text", this._formatText(h)), this._prepareDataItem(d), i && p > 2 ? h = Math.pow(10, Math.log(b) * Math.LOG10E + c - 5) : h += a;
									var f = Math.pow(10, Math.floor(Math.log(Math.abs(a)) * Math.LOG10E));
									if (f < 1) {
										var m = Math.round(Math.abs(Math.log(Math.abs(f)) * Math.LOG10E)) + 2;
										h = u.round(h, m)
									}
									c++
								}
								for (var v = c; v < this.dataItems.length; v++) this.dataItems[v].hide();
								l.each(this.series, (function (e) {
									e.inited && e._markDirtyAxes()
								})), this._updateGhost()
							}
						...
						value: function () {
							...
							if (0 === a && 0 === r && (r = .9, a = -.9), s.isNumber(t) && (a = t), s.isNumber(i) && (r = i), a !== 1 / 0 && r !== -1 / 0) {
								...
								if (s.isNumber(b) && (a = b), s.isNumber(d) && (r = d), a = this._fixMin(a), (r = this._fixMax(r)) - a <= 1 / Math.pow(10, 15)) {
									if (r - a != 0) this._deltaMinMax = (r - a) / 2;
									else {
										var g = Math.log(Math.abs(r)) * Math.LOG10E,
											f = Math.pow(10, Math.floor(g));
										f /= 10, this._deltaMinMax = f
									}
									a -= this._deltaMinMax, r += this._deltaMinMax
								}
								r += (r - (a -= (r - a) * n)) * o, this.get("logarithmic") && (a < 0 && c >= 0 && (a = 0), r > 0 && p <= 0 && (r = 0)), this._minReal = a, this._maxReal = r;
								...
								a = x.min, r = x.max, x = this._adjustMinMax(a, r, _, !0), a = x.min, r = x.max, m && (a = s.isNumber(t) ? t : this._minReal, (r = s.isNumber(i) ? i : this._maxReal) - a <= 1e-8 && (a -= this._deltaMinMax, r += this._deltaMinMax), r += (r - (a -= (r - a) * n)) * o), b = this.adapters.fold("min", a), d = this.adapters.fold("max", r), s.isNumber(b) && (a = b), s.isNumber(d) && (r = d), u == 1 / 0 && (u = r - a);
					...
					return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_makeGraphics", {
						...
						value: function (e, t) {
							var i = this,
								...
								u = e.get(o);
							if (null != l && null != u) {
								var h, c, p, b, d = this._xOpenField,
									g = this._yOpenField,
								...
								if (O.isType("CategoryAxis") && P.isType("CategoryAxis")) {
									...
									if (S = this._aLocationX0 + v - .5, X = this._aLocationX1 + f - .5, _ instanceof n.gG && (S += N = (X - S) * (1 - _.value) / 2, X -= N), h = P.getDataItemPositionX(e, d, S, M), c = P.getDataItemPositionX(e, r, X, M), p = O.getDataItemPositionY(e, o, m, I), this._yOpenField !== this._yField) b = O.getDataItemPositionY(e, g, y, I);
									else if (w) {
									...
									var N;
									if (S = this._aLocationY0 + y - .5, X = this._aLocationY1 + m - .5, x instanceof n.gG && (S += N = (X - S) * (1 - x.value) / 2, X -= N), p = O.getDataItemPositionY(e, g, S, I), b = O.getDataItemPositionY(e, o, X, I), c = P.getDataItemPositionX(e, r, f, M), this._xOpenField !== this._xField) h = P.getDataItemPositionX(e, d, v, M);
									else if (w) {
					...
					return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
						...
						value: function (e, t) {
							...
							var A = [],
								k = [];
							A.push(k);
							var I, M = this.strokes.template.get("templateField"),
						...
						value: function (e) {
							...
							if (t) {
								...
								a && a.setPrivate("visible", !1), i.set("background", d.A.new(i._root, {
									fillOpacity: 0,
									fill: (0, p.$_)(0)
								}));
								...
								if (r.states.create("disabled", {
									...
									if (l) {
										var u = l(i._root, this, new b.z(this, {}, {}));
										if (u) {
											var h = u.get("sprite");
			...
			var a = i(5125),
				...
				b = function (e) {
					...
					return (0, a.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
						...
						writable: !0,
						value: function (e) {
							if (this.updateLegendMarker(e), this.updateLegendValue(e), this.get("tooltip"))
		...
		3955: function (e, t, i) {
			...
			var a = i(6901),
					...
					return (0, r.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
						...
						value: function () {
							...
							var i = this.dataItems.length,
								a = 0;
							this._valuesDirty && (p.each(this.dataItems, (function (e) {
				...
				R = function (e) {
					...
					return (0, r.ZT)(t, e), Object.defineProperty(t.prototype, "makeColumn", {
						...
						configurable: !0,
						writable: !0,
						value: S.$.classNames.concat([t.className])
					}), t
				}(S.$),
				L = i(62),
				V = i(2338),
			...
			var q = function (e) {
					...
					return (0, r.ZT)(t, e), Object.defineProperty(t.prototype, "_afterNew", {
						...
						value: function (e, t) {
							var i = t.points,
								a = this.get("stepWidth", Z.AQ).value / 2,
