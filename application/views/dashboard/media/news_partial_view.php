         ...
         foreach ($newslist as $list) { ?>
            <tr>
               ...
               <td>
                  ...
                  <img src="<?php echo base_url(); ?>assets-admin/img/down.png" alt="Active" title="down arrow" id="active"
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        <button type="button" class="btn tbl-action-btn padbtn"
                           ...
                           style="margin: 3px -6px;"><i class="fas fa-sync-alt" aria-hidden="true"
                              title="click for set precedence"></i> </button>
                     </div>
                  </div>
               </td>
               <td align="center"> <?php if ($list->is_disabled == 0) { ?>
                     <a href="javascript:void(0);"><img src="<?php echo base_url(); ?>assets-admin/img/active-icon.png"
                           alt="Active" title="Active" id="<?php echo ($list->doc_id); ?>" class="news_newslater_status"
                           data-setstatus="1" data-mediatag="<?php echo $media_tag; ?>"></a>

                  <?php } else { ?>
                     <a href="javascript:void(0);"><img src="<?php echo base_url(); ?>assets-admin/img/inactive2.png"
                           alt="Inactive" title="Inactive" id="<?php echo ($list->doc_id); ?>" class="news_newslater_status"
                           data-setstatus="0" data-mediatag="<?php echo $media_tag; ?>"> </a>
                  <?php } ?>
               </td>
