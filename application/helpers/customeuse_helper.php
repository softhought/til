...
if(!function_exists('accesspermission'))
{
	...
	function accesspermission($access_for=NULL){
		...
		// 	$accessIDs=explode(',',$result->access_permission);

	    //     if (in_array($access_for,$accessIDs)) {
	    //     	return '';
	    //     }else{
	    //     	return 'displaynone';
	    //     }
	...
	if(!function_exists('SendEmailxx')){
		function SendEmailxx($email,$sub,$msg,$cc_mail="",$bcc_mail="",$file_attachment="")
			{   
				...
				$mail->Username = "crm@mumbaiangels.com";  // SMTP username
				$mail->Password = "xt%FZ89#35"; // SMTP password
			
				$mail->From = "crm@mumbaiangels.com";
...
if(!function_exists('SendEmail')){
		function SendEmail($to,$subject,$msg,$cc_mail="",$bcc_mail="",$file_attachment="",$replyto="")
			...
			$mail->Username = "subscription@mumbaiangels.com";
			$mail->Password = "Subscription123";
			$mail->SetFrom("subscription@mumbaiangels.com",'Mumbai Angels Subscription');
