...
<script>setBreadcrumbAndBackground('<?php echo base_url(); ?>assets/images/inner_page_banners/Media-page.jpg', "Press Release");</script>
                            ...
                            <table class="til_table_view">
                                ...
                                <tr>
                                    <?php foreach ($bodycontent["investorRelationsDetails"]->file as $key => $file) { ?>
                                        <td><strong class="pdfIcon"><?php echo $file->uploaded_file_desc; ?></strong><br>
                                        </td>
                                        <td>
                                            <aside>
                                                ...
                                                <a href="javascript:void(0)" target="_blank" class="download_pdf"
                                                    onclick="downloadPDF('<?php echo base_url(); ?>assets/docs/pdf/<?php echo $file->random_file_name; ?>', '<?php echo $value->user_file_name; ?>')"
                                                    title="SmartMoves_ABBytes_CW_September_2020.pdf">
