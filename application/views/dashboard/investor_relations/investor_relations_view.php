...
<div class="card card-primary card-outline card-tabs">
   <div class="card-header p-0 pt-1 border-bottom-0">
      <ul class="nav nav-tabs" id="custom-tabs-three-tab" role="tablist">
         <li class="nav-item">
            <a class="nav-link active" id="tab_one-tab" data-toggle="pill" href="#tab_one" role="tab" aria-controls="tab_one" aria-selected="true">Corporate Governance</a>
         </li>

         <li class="nav-item">
            <a class="nav-link" id="tab_two-tab" data-toggle="pill" href="#tab_two" role="tab" aria-controls="tab_two" aria-selected="false" data-mediatag="gdf">Shareholders Information</a>
         </li>

         <li class="nav-item">
            <a class="nav-link" id="tab_three-tab" data-toggle="pill" href="#tab_three" role="tab" aria-controls="tab_three" aria-selected="false">Financials</a>
         </li>
       
         <li class="nav-item">
            <a class="nav-link" id="tab_four-tab" data-toggle="pill" href="#tab_four" role="tab" aria-controls="tab_four" aria-selected="false">Notice</a>
         </li>
...
<div id="investorRelationsDetails" class="modal fade customModal format1 right" data-keyboard="false"
      ...
      <div class="modal-dialog modal-xl" >
          <div class="modal-content">
              ...
              <input type="text" id="investor_relation_head" name="investor_relation_head" value="Corporate Governance" readonly>
